...
- Path处理
  ...
  - [Exploiting-URL-Parsing-Confusion.pdf](./Web%E5%BA%94%E7%94%A8/Server%E7%AB%AF/Exploiting-URL-Parsing-Confusion.pdf)
...
- Apache Shiro
  - 反序列化
    ...
    - [Shiro反序列化漏洞利用汇总（Shiro-550+Shiro-721）](https://www.cnblogs.com/xiaozi/p/13239046.html)


    - [Apache Shiro反序列化识别那些事](https://mp.weixin.qq.com/s/q5sexARASK2TI6ihnRzYjg)


    - [Apache Shiro Java反序列化漏洞分析](https://blog.knownsec.com/2016/08/apache-shiro-java/)(550)
    - [shiro_tool.jar](https://github.com/wyzxxz/shiro_rce)(550)
    - [PaddingOracleAttack-Shiro-721](https://github.com/longofo/PaddingOracleAttack-Shiro-721)(721)
    - [Shiro-721](https://github.com/inspiringz/Shiro-721)(721)
